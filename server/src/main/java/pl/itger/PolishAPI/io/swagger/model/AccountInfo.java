...
@Size(min=1) 
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, nameAddress, accountType, accountTypeName, accountHolderType, accountNameClient, currency, availableBalance, bookingBalance, bank, psuRelations, auxData);
  }

 ...
 */
@ApiModel(description = "Klasa zlecenia przelewu zagranicznego innego niż SEPA w ramach paczki / NonEEA Transfer inside bundle Request Class")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2019-03-14T19:37:54.479+01:00")

public class PaymentNonEEARequestBundled  implements Serializable {
  ...
  public PaymentNonEEARequestBundled recipient(RecipientPISForeign recipient) {
  ...
  **/
  ...
  public PaymentNonEEARequestBundled recipientBank(Bank recipientBank) {
  ...
  **/
  ...
  public PaymentNonEEARequestBundled sender(SenderPISForeign sender) {
    this.sender = sender;
    return this;
  }
  ...
  **/
  ...
  public PaymentNonEEARequestBundled transferData(TransferDataCurrencyRequired transferData) {
  ...
  **/
  ...
  public PaymentNonEEARequestBundled transferCharges(String transferCharges) {
...
@Size(max=3) 
  ...
  public PaymentNonEEARequestBundled tppTransactionId(String tppTransactionId) {
...
@Size(max=64) 
  ...
  public PaymentNonEEARequestBundled deliveryMode(DeliveryModeEnum deliveryMode) {
  ...
  **/
  ...
  public PaymentNonEEARequestBundled system(SystemEnum system) {
    this.system = system;
    return this;
  }
  ...
  **/
  ...
  public PaymentNonEEARequestBundled hold(Boolean hold) {
    this.hold = hold;
    return this;
  }
  ...
  **/
  ...
  public PaymentNonEEARequestBundled executionMode(ExecutionModeEnum executionMode) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentNonEEARequestBundled paymentNonEEARequestBundled = (PaymentNonEEARequestBundled) o;
    return Objects.equals(this.recipient, paymentNonEEARequestBundled.recipient) &&
        Objects.equals(this.recipientBank, paymentNonEEARequestBundled.recipientBank) &&
        Objects.equals(this.sender, paymentNonEEARequestBundled.sender) &&
        Objects.equals(this.transferData, paymentNonEEARequestBundled.transferData) &&
        Objects.equals(this.transferCharges, paymentNonEEARequestBundled.transferCharges) &&
        Objects.equals(this.tppTransactionId, paymentNonEEARequestBundled.tppTransactionId) &&
        Objects.equals(this.deliveryMode, paymentNonEEARequestBundled.deliveryMode) &&
        Objects.equals(this.system, paymentNonEEARequestBundled.system) &&
        Objects.equals(this.hold, paymentNonEEARequestBundled.hold) &&
        Objects.equals(this.executionMode, paymentNonEEARequestBundled.executionMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recipient, recipientBank, sender, transferData, transferCharges, tppTransactionId, deliveryMode, system, hold, executionMode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentNonEEARequestBundled {\n");

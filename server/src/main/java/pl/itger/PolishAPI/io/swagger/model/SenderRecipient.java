 ...
 */
@ApiModel(description = "Klasa zawierająca dane nadawcy/odbiorcy używana w żądaniach AIS / AIS Sender Recipient Data Class")
@Validated
...
public class SenderRecipient  implements Serializable {
  ...
  **/
  @ApiModelProperty(value = "Numer wirtualny rachunku odbiorcy w formacie / Virtual account name")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountNumber, senderRecipient.accountNumber) &&
        Objects.equals(this.accountMassPayment, senderRecipient.accountMassPayment) &&
        Objects.equals(this.bank, senderRecipient.bank) &&
        Objects.equals(this.nameAddress, senderRecipient.nameAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountMassPayment, bank, nameAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("    accountMassPayment: ").append(toIndentedString(accountMassPayment)).append("\n");

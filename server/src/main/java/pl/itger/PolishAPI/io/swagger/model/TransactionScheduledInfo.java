...
/**
 * Klasa opisująca zaplanowaną transakcję płatniczą
 */
@ApiModel(description = "Klasa opisująca zaplanowaną transakcję płatniczą")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2019-03-13T14:12:57.306+01:00")

public class TransactionScheduledInfo   {
  @JsonProperty("itemId")

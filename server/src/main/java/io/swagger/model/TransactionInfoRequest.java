...
import io.swagger.model.ItemInfoRequestBase;
import io.swagger.model.RequestHeaderAISCallback;
 ...
 */
@ApiModel(description = "Klasa zapytania o transakcje / Transaction Information Request Class")
@Validated
...
public class TransactionInfoRequest  implements Serializable {
  ...
  public TransactionInfoRequest requestHeader(RequestHeaderAISCallback requestHeader) {
  ...
  **/
  ...
  public TransactionInfoRequest accountNumber(String accountNumber) {
  ...
  **/
  ...
  public TransactionInfoRequest itemIdFrom(String itemIdFrom) {
...
@Size(max=64) 
  ...
  public TransactionInfoRequest transactionDateFrom(LocalDate transactionDateFrom) {
  ...
  **/
  ...
  public TransactionInfoRequest transactionDateTo(LocalDate transactionDateTo) {
  ...
  **/
  ...
  public TransactionInfoRequest bookingDateFrom(LocalDate bookingDateFrom) {
  ...
  **/
  ...
  public TransactionInfoRequest bookingDateTo(LocalDate bookingDateTo) {
  ...
  **/
  ...
  public TransactionInfoRequest minAmount(String minAmount) {
...
@Pattern(regexp="^(0|([1-9][0-9]{0,}))\\.\\d{2}$") 
  ...
  public TransactionInfoRequest maxAmount(String maxAmount) {
...
@Pattern(regexp="^(0|([1-9][0-9]{0,}))\\.\\d{2}$") 
  ...
  public TransactionInfoRequest pageId(String pageId) {
    this.pageId = pageId;
    return this;
  }
  ...
  **/
  ...
  public TransactionInfoRequest perPage(Integer perPage) {
...
@Min(1)
  ...
  public TransactionInfoRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.requestHeader, transactionInfoRequest.requestHeader) &&
        Objects.equals(this.accountNumber, transactionInfoRequest.accountNumber) &&
        Objects.equals(this.itemIdFrom, transactionInfoRequest.itemIdFrom) &&
        Objects.equals(this.transactionDateFrom, transactionInfoRequest.transactionDateFrom) &&
        Objects.equals(this.transactionDateTo, transactionInfoRequest.transactionDateTo) &&
        Objects.equals(this.bookingDateFrom, transactionInfoRequest.bookingDateFrom) &&
        Objects.equals(this.bookingDateTo, transactionInfoRequest.bookingDateTo) &&
        Objects.equals(this.minAmount, transactionInfoRequest.minAmount) &&
        Objects.equals(this.maxAmount, transactionInfoRequest.maxAmount) &&
        Objects.equals(this.pageId, transactionInfoRequest.pageId) &&
        Objects.equals(this.perPage, transactionInfoRequest.perPage) &&
        Objects.equals(this.type, transactionInfoRequest.type);
  }

...
public interface CafApi {
    ...
    @ApiOperation(value = "Potwierdzenie dostępności środków na rachunku / Confirmation of the availability of funds", nickname = "getConfirmationOfFunds", notes = "Potwierdzenie dostępności na rachunku płatnika kwoty niezbędnej do wykonania transakcji płatniczej, o której mowa w Art. 62 PSD2. / Confirming the availability on the payers account of the amount necessary to execute the payment transaction, as defined in Art. 65 PSD2.", response = ConfirmationOfFundsResponse.class, tags={ "CAF", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Powodzenie / Success", response = ConfirmationOfFundsResponse.class),
        ...
        @ApiResponse(code = 429, message = "Wyczerpany limit ilości żądań / Wyczerpany limit ilości żądań / Request limit for the requested service exceeded", response = Error.class),

...
public class PrivilegeForeignTransferNonEEA  implements Serializable {
  ...
  **/
  ...
  public PrivilegeForeignTransferNonEEA sender(SenderPIS sender) {
    this.sender = sender;
    return this;
  }
...
@Size(max=3) 
  ...
  **/
  ...
  public PrivilegeForeignTransferNonEEA hold(Boolean hold) {
    this.hold = hold;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.scopeUsageLimit, privilegeForeignTransferNonEEA.scopeUsageLimit) &&
        ...
        Objects.equals(this.hold, privilegeForeignTransferNonEEA.hold) &&
        Objects.equals(this.executionMode, privilegeForeignTransferNonEEA.executionMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scopeUsageLimit, recipient, recipientBank, sender, transferData, transferCharges, deliveryMode, system, hold, executionMode);
  }

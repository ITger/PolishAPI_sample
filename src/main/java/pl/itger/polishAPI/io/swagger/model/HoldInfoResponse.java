...
/**
 * Klasa odpowiedzi zawierająca listę blokad na rachunku / Class of response with the list of holds
 */
@ApiModel(description = "Klasa odpowiedzi zawierająca listę blokad na rachunku / Class of response with the list of holds")
@Validated

...
@Size(max=100) 
  ...
  **/
  ...
  /**
   * Data ważności blokady, YYYY-MM-DDThh:mm:ss[.mmm] / Expiration date of hold
   * @return holdExpirationDate
  **/
  @ApiModelProperty(value = "Data ważności blokady, YYYY-MM-DDThh:mm:ss[.mmm] / Expiration date of hold")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.itemId, holdInfo.itemId) &&
        Objects.equals(this.amount, holdInfo.amount) &&
        Objects.equals(this.currency, holdInfo.currency) &&
        Objects.equals(this.description, holdInfo.description) &&
        Objects.equals(this.transactionType, holdInfo.transactionType) &&
        Objects.equals(this.tradeDate, holdInfo.tradeDate) &&
        Objects.equals(this.mcc, holdInfo.mcc) &&
        Objects.equals(this.auxData, holdInfo.auxData) &&
        Objects.equals(this.holdExpirationDate, holdInfo.holdExpirationDate) &&
        Objects.equals(this.initiator, holdInfo.initiator) &&
        Objects.equals(this.sender, holdInfo.sender) &&
        Objects.equals(this.recipient, holdInfo.recipient);
  }

  @Override
  public int hashCode() {
    return Objects.hash(itemId, amount, currency, description, transactionType, tradeDate, mcc, auxData, holdExpirationDate, initiator, sender, recipient);
  }

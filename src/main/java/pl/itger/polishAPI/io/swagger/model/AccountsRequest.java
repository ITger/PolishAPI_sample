...
public class AccountsRequest  implements Serializable {
  ...
  /**
   * Używane w celu filtrowania - typ relacji PSU do rachunku / Used for filtering the results - type of relation between PSU and an Account
   */
  ...
  **/
  @ApiModelProperty(value = "Używane w celu filtrowania - typ relacji PSU do rachunku / Used for filtering the results - type of relation between PSU and an Account")

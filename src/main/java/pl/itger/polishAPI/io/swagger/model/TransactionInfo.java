...
/**
 * Klasa opisująca transakcję płatniczą / Class describing the payment transaction
 */
@ApiModel(description = "Klasa opisująca transakcję płatniczą / Class describing the payment transaction")
@Validated
...
@Size(max=100) 
  ...
  **/
  ...
  /**
   * Data księgowania, YYYY-MM-DDThh:mm:ss[.mmm]. Wymagane warunkowo - w przypadku transakcji zaksięgowanych. / Booking date. Conditional - in case of booked transactions.
   * @return bookingDate
  **/
  @ApiModelProperty(value = "Data księgowania, YYYY-MM-DDThh:mm:ss[.mmm]. Wymagane warunkowo - w przypadku transakcji zaksięgowanych. / Booking date. Conditional - in case of booked transactions.")
  ...
  /**
   * Saldo rachunku po transakcji. Wymagane warunkowo - w przypadku transakcji zaksięgowanych. / Account balance after the transaction is booked. Conditional - in case of booked transactions.
   * @return postTransactionBalance
  **/
  @ApiModelProperty(value = "Saldo rachunku po transakcji. Wymagane warunkowo - w przypadku transakcji zaksięgowanych. / Account balance after the transaction is booked. Conditional - in case of booked transactions.")

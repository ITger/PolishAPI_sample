...
public class AccountInfo  implements Serializable {
  ...
  private String vatAccountNrb = null;

  @JsonProperty("linkedAccountNumber")
  @Valid
  private List<String> linkedAccountNumber = null;
  ...
  **/
  @ApiModelProperty(value = "Nazwa typu rachunku (definiowana przez ASPSP) / Account's type name (defined by ASPSP)")
...
@Size(max=32) 
  ...
  **/
  @ApiModelProperty(required = true, value = "Rodzaj posiadacza rachunku: osoba fizyczna lub osoba prawna / Account holder type: individual person or corporation")
  @NotNull
  ...
  **/
  @ApiModelProperty(value = "Nazwa konta ustawiona przez klienta / Account name set by the client")
...
@Size(max=32) 
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "Waluta rachunku / Currency")
  @NotNull
...
@Size(max=3) 
  ...
  **/
  @ApiModelProperty(required = true, value = "Dostępne środki - po wykonaniu transakcji / Available funds")
  @NotNull
...
@Pattern(regexp="^(0|([1-9][0-9]{0,}))\\.\\d{2}$") 
  ...
  **/
  @ApiModelProperty(required = true, value = "Saldo księgowe rachunku - po wykonaniu transakcji / Book balance of the account")
  @NotNull
...
@Pattern(regexp="^-?(0|([1-9][0-9]{0,}))\\.\\d{2}$") 
  ...
  **/
  ...
  /**
   * Informacje na temat relacji PSU do rachunku / Description of relations between PSU and an Account
   * @return psuRelations
  **/
  @ApiModelProperty(required = true, value = "Informacje na temat relacji PSU do rachunku / Description of relations between PSU and an Account")
  @NotNull
...
@Size(min=1) 
  ...
  public AccountInfo vatAccountNrb(String vatAccountNrb) {
    this.vatAccountNrb = vatAccountNrb;
    return this;
  }

  /**
   * Numer rachunku VAT / VAT account number
   * @return vatAccountNrb
  **/
  @ApiModelProperty(value = "Numer rachunku VAT / VAT account number")


  public String getVatAccountNrb() {
    return vatAccountNrb;
  }

  public void setVatAccountNrb(String vatAccountNrb) {
    this.vatAccountNrb = vatAccountNrb;
  }

  public AccountInfo linkedAccountNumber(List<String> linkedAccountNumber) {
    this.linkedAccountNumber = linkedAccountNumber;
    return this;
  }

  public AccountInfo addLinkedAccountNumberItem(String linkedAccountNumberItem) {
    if (this.linkedAccountNumber == null) {
      this.linkedAccountNumber = new ArrayList<>();
    }
    this.linkedAccountNumber.add(linkedAccountNumberItem);
    return this;
  }

  /**
   * Lista numerów rachunkuów powiązanych z rachunkiem VAT / Account numbers list related to VAT account
   * @return linkedAccountNumber
  **/
  @ApiModelProperty(value = "Lista numerów rachunkuów powiązanych z rachunkiem VAT / Account numbers list related to VAT account")


  public List<String> getLinkedAccountNumber() {
    return linkedAccountNumber;
  }

  public void setLinkedAccountNumber(List<String> linkedAccountNumber) {
    this.linkedAccountNumber = linkedAccountNumber;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountNumber, accountInfo.accountNumber) &&
        Objects.equals(this.nameAddress, accountInfo.nameAddress) &&
        Objects.equals(this.accountType, accountInfo.accountType) &&
        Objects.equals(this.accountTypeName, accountInfo.accountTypeName) &&
        Objects.equals(this.accountHolderType, accountInfo.accountHolderType) &&
        Objects.equals(this.accountNameClient, accountInfo.accountNameClient) &&
        Objects.equals(this.currency, accountInfo.currency) &&
        Objects.equals(this.availableBalance, accountInfo.availableBalance) &&
        Objects.equals(this.bookingBalance, accountInfo.bookingBalance) &&
        Objects.equals(this.bank, accountInfo.bank) &&
        Objects.equals(this.psuRelations, accountInfo.psuRelations) &&
        Objects.equals(this.vatAccountNrb, accountInfo.vatAccountNrb) &&
        Objects.equals(this.linkedAccountNumber, accountInfo.linkedAccountNumber) &&
        Objects.equals(this.auxData, accountInfo.auxData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, nameAddress, accountType, accountTypeName, accountHolderType, accountNameClient, currency, availableBalance, bookingBalance, bank, psuRelations, vatAccountNrb, linkedAccountNumber, auxData);
  }
  ...
  public String toString() {
    ...
    sb.append("    accountNameClient: ").append(toIndentedString(accountNameClient)).append("\n");
    sb.append("    currency: ").append(toIndentedString(currency)).append("\n");
    sb.append("    availableBalance: ").append(toIndentedString(availableBalance)).append("\n");
    sb.append("    bookingBalance: ").append(toIndentedString(bookingBalance)).append("\n");
    sb.append("    bank: ").append(toIndentedString(bank)).append("\n");
    sb.append("    psuRelations: ").append(toIndentedString(psuRelations)).append("\n");
    sb.append("    vatAccountNrb: ").append(toIndentedString(vatAccountNrb)).append("\n");
    sb.append("    linkedAccountNumber: ").append(toIndentedString(linkedAccountNumber)).append("\n");

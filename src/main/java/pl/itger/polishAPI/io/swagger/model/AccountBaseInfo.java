...
public class AccountBaseInfo  implements Serializable {
  ...
  **/
  @ApiModelProperty(required = true, value = "Numer rachunku (częściowo zamaskowany) / Account number (partly masked)")
  @NotNull
  ...
  **/
  @ApiModelProperty(required = true, value = "Nazwa typu rachunku (definiowana przez ASPSP) / Account's type name (defined by ASPSP)")
  @NotNull
...
@Size(min=1) 
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountNumber, accountBaseInfo.accountNumber) &&
        Objects.equals(this.accountTypeName, accountBaseInfo.accountTypeName) &&
        Objects.equals(this.accountType, accountBaseInfo.accountType) &&
        Objects.equals(this.psuRelations, accountBaseInfo.psuRelations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountTypeName, accountType, psuRelations);
  }

...
/**
 * Klasa zapytania o usunięcie zgody na dostęp do AIS / Class of request for removal of consent to access to AIS
 */
@ApiModel(description = "Klasa zapytania o usunięcie zgody na dostęp do AIS / Class of request for removal of consent to access to AIS")
@Validated

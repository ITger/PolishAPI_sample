...
/**
 * Klasa odpowiedzi zawierająca listę zakończonych transakcji / Class of response with the list of booked transactions
 */
@ApiModel(description = "Klasa odpowiedzi zawierająca listę zakończonych transakcji / Class of response with the list of booked transactions")
@Validated

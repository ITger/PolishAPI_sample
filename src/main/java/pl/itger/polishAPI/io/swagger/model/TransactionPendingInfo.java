...
/**
 * Klasa opisująca oczekującą transakcję płatniczą. / Class describing pending payment transaction.
 */
@ApiModel(description = "Klasa opisująca oczekującą transakcję płatniczą. / Class describing pending payment transaction.")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2019-12-26T17:08:40.154+01:00")

public class TransactionPendingInfo  implements Serializable {
  ...
  public TransactionPendingInfo itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
...
@Size(max=128) 
  ...
  public TransactionPendingInfo amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^(0|([1-9][0-9]{0,}))\\.\\d{2}$") 
  ...
  public TransactionPendingInfo currency(String currency) {
...
@Size(max=3) 
  ...
  public TransactionPendingInfo description(String description) {
...
@Size(max=140) 
  ...
  public TransactionPendingInfo transactionType(String transactionType) {
...
@Size(max=100) 
  ...
  public TransactionPendingInfo tradeDate(OffsetDateTime tradeDate) {
  ...
  **/
  ...
  public TransactionPendingInfo mcc(String mcc) {
    this.mcc = mcc;
    return this;
  }
  ...
  **/
  ...
  public TransactionPendingInfo auxData(java.util.Map auxData) {
  ...
  **/
  ...
  public TransactionPendingInfo transactionCategory(TransactionCategoryEnum transactionCategory) {
  ...
  **/
  ...
  public TransactionPendingInfo initiator(NameAddress initiator) {
  ...
  **/
  ...
  public TransactionPendingInfo sender(SenderRecipient sender) {
    this.sender = sender;
    return this;
  }
  ...
  **/
  ...
  public TransactionPendingInfo recipient(SenderRecipient recipient) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransactionPendingInfo transactionPendingInfo = (TransactionPendingInfo) o;
    return Objects.equals(this.itemId, transactionPendingInfo.itemId) &&
        Objects.equals(this.amount, transactionPendingInfo.amount) &&
        Objects.equals(this.currency, transactionPendingInfo.currency) &&
        Objects.equals(this.description, transactionPendingInfo.description) &&
        Objects.equals(this.transactionType, transactionPendingInfo.transactionType) &&
        Objects.equals(this.tradeDate, transactionPendingInfo.tradeDate) &&
        Objects.equals(this.mcc, transactionPendingInfo.mcc) &&
        Objects.equals(this.auxData, transactionPendingInfo.auxData) &&
        Objects.equals(this.transactionCategory, transactionPendingInfo.transactionCategory) &&
        Objects.equals(this.initiator, transactionPendingInfo.initiator) &&
        Objects.equals(this.sender, transactionPendingInfo.sender) &&
        Objects.equals(this.recipient, transactionPendingInfo.recipient);
  }

  @Override
  public int hashCode() {
    return Objects.hash(itemId, amount, currency, description, transactionType, tradeDate, mcc, auxData, transactionCategory, initiator, sender, recipient);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TransactionPendingInfo {\n");

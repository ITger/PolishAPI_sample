...
/**
 * Klasa opisująca odrzuconą transakcję płatniczą / Class describing the rejected payment transaction
 */
@ApiModel(description = "Klasa opisująca odrzuconą transakcję płatniczą / Class describing the rejected payment transaction")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2019-12-26T17:08:40.154+01:00")

public class TransactionRejectedInfo  implements Serializable {
...
@Size(max=140) 
  ...
  /**
   * Data odrzucenia, YYYY-MM-DDThh:mm:ss[.mmm] / Rejection date
   * @return rejectionDate
  **/
  @ApiModelProperty(value = "Data odrzucenia, YYYY-MM-DDThh:mm:ss[.mmm] / Rejection date")

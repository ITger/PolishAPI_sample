 ...
 */
@ApiModel(description = "Klasa zlecenia przelewu krajowego w ramach paczki / Domestic Transfer inside bundle Request Class")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2019-12-26T17:08:40.154+01:00")

public class PaymentDomesticRequestBundled  implements Serializable {
  ...
  public PaymentDomesticRequestBundled recipient(RecipientPIS recipient) {
  ...
  **/
  ...
  public PaymentDomesticRequestBundled sender(SenderPIS sender) {
    this.sender = sender;
    return this;
  }
  ...
  **/
  ...
  public PaymentDomesticRequestBundled transferData(TransferData transferData) {
  ...
  **/
  ...
  public PaymentDomesticRequestBundled tppTransactionId(String tppTransactionId) {
...
@Size(max=128) 
  ...
  public PaymentDomesticRequestBundled deliveryMode(DeliveryModeEnum deliveryMode) {
  ...
  **/
  ...
  public PaymentDomesticRequestBundled system(SystemEnum system) {
    this.system = system;
    return this;
  }
  ...
  **/
  ...
  public PaymentDomesticRequestBundled hold(Boolean hold) {
    this.hold = hold;
    return this;
  }
  ...
  **/
  ...
  public PaymentDomesticRequestBundled executionMode(ExecutionModeEnum executionMode) {
  ...
  **/
  ...
  public PaymentDomesticRequestBundled splitPayment(Boolean splitPayment) {
  ...
  **/
  ...
  public PaymentDomesticRequestBundled transactionInfoSp(TransactionInfoSp transactionInfoSp) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentDomesticRequestBundled paymentDomesticRequestBundled = (PaymentDomesticRequestBundled) o;
    return Objects.equals(this.recipient, paymentDomesticRequestBundled.recipient) &&
        Objects.equals(this.sender, paymentDomesticRequestBundled.sender) &&
        Objects.equals(this.transferData, paymentDomesticRequestBundled.transferData) &&
        Objects.equals(this.tppTransactionId, paymentDomesticRequestBundled.tppTransactionId) &&
        Objects.equals(this.deliveryMode, paymentDomesticRequestBundled.deliveryMode) &&
        Objects.equals(this.system, paymentDomesticRequestBundled.system) &&
        Objects.equals(this.hold, paymentDomesticRequestBundled.hold) &&
        Objects.equals(this.executionMode, paymentDomesticRequestBundled.executionMode) &&
        Objects.equals(this.splitPayment, paymentDomesticRequestBundled.splitPayment) &&
        Objects.equals(this.transactionInfoSp, paymentDomesticRequestBundled.transactionInfoSp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recipient, sender, transferData, tppTransactionId, deliveryMode, system, hold, executionMode, splitPayment, transactionInfoSp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentDomesticRequestBundled {\n");

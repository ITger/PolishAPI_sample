...
/**
 * Klasa odpowiedzi zawierająca listę anulowanych transakcji / Class of response with the list of cancelled transactions
 */
@ApiModel(description = "Klasa odpowiedzi zawierająca listę anulowanych transakcji / Class of response with the list of cancelled transactions")
@Validated

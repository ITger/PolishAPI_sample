 ...
 */
@ApiModel(description = "Klasa zlecenia przelewu podatkowego w ramach paczki / Tax Transfer inside bundle Request Class")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2019-03-14T19:37:54.479+01:00")

public class PaymentTaxRequestBundled implements Serializable {
    ...
    public PaymentTaxRequestBundled recipient(RecipientPISTax recipient) {
    ...
    public PaymentTaxRequestBundled sender(SenderPISDomestic sender) {
        this.sender = sender;
        return this;
    }
    ...
    public PaymentTaxRequestBundled transferData(TransferDataCurrencyRequiredTax transferData) {
    ...
    public PaymentTaxRequestBundled usInfo(TransactionInfoTax usInfo) {
        this.usInfo = usInfo;
        return this;
    }
    ...
    public PaymentTaxRequestBundled tppTransactionId(String tppTransactionId) {
    ...
    public PaymentTaxRequestBundled deliveryMode(DeliveryModeEnum deliveryMode) {
    ...
    public PaymentTaxRequestBundled system(SystemEnum system) {
        this.system = system;
        return this;
    }
    ...
    public PaymentTaxRequestBundled hold(Boolean hold) {
        this.hold = hold;
        return this;
    }
    ...
    public PaymentTaxRequestBundled executionMode(ExecutionModeEnum executionMode) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentTaxRequestBundled paymentTaxRequestBundled = (PaymentTaxRequestBundled) o;
        return Objects.equals(this.recipient, paymentTaxRequestBundled.recipient) &&
                Objects.equals(this.sender, paymentTaxRequestBundled.sender) &&
                Objects.equals(this.transferData, paymentTaxRequestBundled.transferData) &&
                Objects.equals(this.usInfo, paymentTaxRequestBundled.usInfo) &&
                Objects.equals(this.tppTransactionId, paymentTaxRequestBundled.tppTransactionId) &&
                Objects.equals(this.deliveryMode, paymentTaxRequestBundled.deliveryMode) &&
                Objects.equals(this.system, paymentTaxRequestBundled.system) &&
                Objects.equals(this.hold, paymentTaxRequestBundled.hold) &&
                Objects.equals(this.executionMode, paymentTaxRequestBundled.executionMode);
    }

    @Override
    public int hashCode() {
        return Objects.hash(recipient, sender, transferData, usInfo, tppTransactionId, deliveryMode, system, hold, executionMode);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class PaymentTaxRequestBundled {\n");
